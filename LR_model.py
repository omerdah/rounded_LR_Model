...
meteo_feats = stats_per_season_and_area[['עונת גידול','אזור','לחות יחסית ממוצע לילה', 'עננות ממוצע יום']]
all_features = ['השקיה','סוג הקרקע','כרב/גידול קודם','אופן הדברה','סוג זבל','טיפוס תירס', "מס' דונם", 'לחות יחסית ממוצע לילה', 'עננות ממוצע יום','מועד זריעה']
